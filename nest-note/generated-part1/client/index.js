...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\code\\nest-playground\\nest-note\\generated-part1\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated-part1/client\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\n// 一对多\nmodel Department {\n  id         Int        @id @default(autoincrement())\n  name       String     @db.VarChar(20)\n  createTime DateTime   @default(now())\n  updateTime DateTime   @updatedAt\n  employees  Employee[]\n}\n\nmodel Employee {\n  id           Int        @id @default(autoincrement())\n  name         String     @db.VarChar(20)\n  phone        String     @db.VarChar(30)\n  deaprtmentId Int\n  department   Department @relation(fields: [deaprtmentId], references: [id])\n}\n",
  "inlineSchemaHash": "f8ca986ab0e9a6746b9ad61e6dfb2278753eb031b350ce50ba40df195da81d4f",
  "copyEngine": true
}
...
path.join(process.cwd(), "generated-part1/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated-part1/client/schema.prisma")
